# Solicitation SOL-DOD-005 - Synthetic Readiness Modeling Engagement (SRME)

## Section A - Solicitation/Contract Form
This solicitation is issued by the DoD-DLA as a RFP for the Synthetic Readiness Modeling Engagement (SRME)
program under NAICS 541330. The acquisition vehicle is CPFF; this
...
identifier: SOL-DOD-005. Reference date: 2026-06-09.
...
proposal as separately priced line items. For the Synthetic Readiness Modeling Engagement (SRME), estimated
...
(SOW) in support of the Synthetic Readiness Modeling Engagement (SRME). Tasks include strategy, design,
...
NAICS 541330 domain. Performance shall be measured against the metrics in
Section E (Inspection and Acceptance) and delivery schedule in Section F.

### C.1 Scope

The scope encompasses end-to-end services for the Synthetic Readiness Modeling Engagement (SRME) including
...
The DoD-DLA is undertaking the Synthetic Readiness Modeling Engagement (SRME) to modernize and expand
mission-critical capabilities aligned with strategic priorities. Prior
analogous activities under NAICS 541330 have informed the requirements; this
