# Solicitation SOL-DOD-004 - Synthetic Spare Parts Acquisition Vehicle (SSPAV)

## Section A - Solicitation/Contract Form
This solicitation is issued by the DoD-DLA as a RFI for the Synthetic Spare Parts Acquisition Vehicle (SSPAV)
program under NAICS 332912. The acquisition vehicle is IDIQ; this
...
identifier: SOL-DOD-004. Reference date: 2026-06-09.

## Section B - Supplies/Services and Prices/Costs
Supplies and services required under this solicitation are described in
Section C. Pricing under IDIQ shall be submitted in the offeror's
proposal as separately priced line items. For the Synthetic Spare Parts Acquisition Vehicle (SSPAV), estimated
...
or cost-plus-fixed-fee arrangements consistent with the IDIQ vehicle.

## Section C - Statement of Work
The Contractor shall perform the work described in this Statement of Work
(SOW) in support of the Synthetic Spare Parts Acquisition Vehicle (SSPAV). Tasks include strategy, design,
...
NAICS 332912 domain. Performance shall be measured against the metrics in
Section E (Inspection and Acceptance) and delivery schedule in Section F.

### C.1 Scope

The scope encompasses end-to-end services for the Synthetic Spare Parts Acquisition Vehicle (SSPAV) including
...
The DoD-DLA is undertaking the Synthetic Spare Parts Acquisition Vehicle (SSPAV) to modernize and expand
mission-critical capabilities aligned with strategic priorities. Prior
analogous activities under NAICS 332912 have informed the requirements; this
