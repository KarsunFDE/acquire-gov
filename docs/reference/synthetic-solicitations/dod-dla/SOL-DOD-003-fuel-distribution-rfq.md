# Solicitation SOL-DOD-003 - Synthetic Fuel Distribution Initiative (SFDI)

## Section A - Solicitation/Contract Form
This solicitation is issued by the DoD-DLA as a RFQ for the Synthetic Fuel Distribution Initiative (SFDI)
program under NAICS 324110. The acquisition vehicle is FFP; this
solicitation is set aside for 8(a) concerns. All offers must be
...
identifier: SOL-DOD-003. Reference date: 2026-06-09.
...
proposal as separately priced line items. For the Synthetic Fuel Distribution Initiative (SFDI), estimated
...
(SOW) in support of the Synthetic Fuel Distribution Initiative (SFDI). Tasks include strategy, design,
...
NAICS 324110 domain. Performance shall be measured against the metrics in
Section E (Inspection and Acceptance) and delivery schedule in Section F.

### C.1 Scope

The scope encompasses end-to-end services for the Synthetic Fuel Distribution Initiative (SFDI) including
...
The DoD-DLA is undertaking the Synthetic Fuel Distribution Initiative (SFDI) to modernize and expand
mission-critical capabilities aligned with strategic priorities. Prior
analogous activities under NAICS 324110 have informed the requirements; this
...
8(a) set-aside scope, the Contractor shall comply with the
