# Solicitation SOL-GSA-001 - Synthetic Cloud Modernization Pathway (SCMP)

## Section A - Solicitation/Contract Form
This solicitation is issued by the GSA-FAS as a RFP for the Synthetic Cloud Modernization Pathway (SCMP)
program under NAICS 541512. The acquisition vehicle is BPA; this
solicitation is set aside for Small Business concerns. All offers must be
...
identifier: SOL-GSA-001. Reference date: 2026-06-09.

## Section B - Supplies/Services and Prices/Costs
Supplies and services required under this solicitation are described in
Section C. Pricing under BPA shall be submitted in the offeror's
proposal as separately priced line items. For the Synthetic Cloud Modernization Pathway (SCMP), estimated
...
or cost-plus-fixed-fee arrangements consistent with the BPA vehicle.

## Section C - Statement of Work
The Contractor shall perform the work described in this Statement of Work
(SOW) in support of the Synthetic Cloud Modernization Pathway (SCMP). Tasks include strategy, design,
implementation, operations, and modernization activities tailored to the
GSA-FAS mission. All work shall comply with applicable Federal Acquisition
...
NAICS 541512 domain. Performance shall be measured against the metrics in
Section E (Inspection and Acceptance) and delivery schedule in Section F.

### C.1 Scope

The scope encompasses end-to-end services for the Synthetic Cloud Modernization Pathway (SCMP) including
...
The GSA-FAS is undertaking the Synthetic Cloud Modernization Pathway (SCMP) to modernize and expand
mission-critical capabilities aligned with strategic priorities. Prior
analogous activities under NAICS 541512 have informed the requirements; this
...
Small Business set-aside scope, the Contractor shall comply with the
...
(doc_class=far_reference) at snapshot_date=2026-06-09 for the
...
### 13.303-2  Establishment of BPAs - Procedures
