# Solicitation SOL-GSA-003 - Synthetic Finance ERP Refresh Initiative (SFERI)

## Section A - Solicitation/Contract Form
This solicitation is issued by the GSA-FAS as a RFQ for the Synthetic Finance ERP Refresh Initiative (SFERI)
program under NAICS 518210. The acquisition vehicle is FFP; this
solicitation is set aside for Full-and-Open concerns. All offers must be
...
identifier: SOL-GSA-003. Reference date: 2026-06-09.
...
proposal as separately priced line items. For the Synthetic Finance ERP Refresh Initiative (SFERI), estimated
...
(SOW) in support of the Synthetic Finance ERP Refresh Initiative (SFERI). Tasks include strategy, design,
...
NAICS 518210 domain. Performance shall be measured against the metrics in
Section E (Inspection and Acceptance) and delivery schedule in Section F.

### C.1 Scope

The scope encompasses end-to-end services for the Synthetic Finance ERP Refresh Initiative (SFERI) including
...
The GSA-FAS is undertaking the Synthetic Finance ERP Refresh Initiative (SFERI) to modernize and expand
mission-critical capabilities aligned with strategic priorities. Prior
analogous activities under NAICS 518210 have informed the requirements; this
...
Full-and-Open set-aside scope, the Contractor shall comply with the
