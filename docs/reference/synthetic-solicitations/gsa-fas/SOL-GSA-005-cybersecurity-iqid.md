# Solicitation SOL-GSA-005 - Synthetic Cyber Resilience Acquisition (SCRA)

## Section A - Solicitation/Contract Form
This solicitation is issued by the GSA-FAS as a RFI for the Synthetic Cyber Resilience Acquisition (SCRA)
program under NAICS 541519. The acquisition vehicle is IDIQ; this
...
identifier: SOL-GSA-005. Reference date: 2026-06-09.
...
proposal as separately priced line items. For the Synthetic Cyber Resilience Acquisition (SCRA), estimated
...
(SOW) in support of the Synthetic Cyber Resilience Acquisition (SCRA). Tasks include strategy, design,
...
NAICS 541519 domain. Performance shall be measured against the metrics in
Section E (Inspection and Acceptance) and delivery schedule in Section F.

### C.1 Scope

The scope encompasses end-to-end services for the Synthetic Cyber Resilience Acquisition (SCRA) including
...
The GSA-FAS is undertaking the Synthetic Cyber Resilience Acquisition (SCRA) to modernize and expand
mission-critical capabilities aligned with strategic priorities. Prior
analogous activities under NAICS 541519 have informed the requirements; this
