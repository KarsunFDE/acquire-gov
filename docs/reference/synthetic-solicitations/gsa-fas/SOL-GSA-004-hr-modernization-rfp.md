# Solicitation SOL-GSA-004 - Synthetic HR Operations Transformation Program (SHOT)

## Section A - Solicitation/Contract Form
This solicitation is issued by the GSA-FAS as a RFP for the Synthetic HR Operations Transformation Program (SHOT)
program under NAICS 541611. The acquisition vehicle is CPFF; this
solicitation is set aside for SDVOSB concerns. All offers must be
...
identifier: SOL-GSA-004. Reference date: 2026-06-09.

## Section B - Supplies/Services and Prices/Costs
Supplies and services required under this solicitation are described in
Section C. Pricing under CPFF shall be submitted in the offeror's
proposal as separately priced line items. For the Synthetic HR Operations Transformation Program (SHOT), estimated
...
or cost-plus-fixed-fee arrangements consistent with the CPFF vehicle.

## Section C - Statement of Work
The Contractor shall perform the work described in this Statement of Work
(SOW) in support of the Synthetic HR Operations Transformation Program (SHOT). Tasks include strategy, design,
...
NAICS 541611 domain. Performance shall be measured against the metrics in
Section E (Inspection and Acceptance) and delivery schedule in Section F.

### C.1 Scope

The scope encompasses end-to-end services for the Synthetic HR Operations Transformation Program (SHOT) including
...
The GSA-FAS is undertaking the Synthetic HR Operations Transformation Program (SHOT) to modernize and expand
mission-critical capabilities aligned with strategic priorities. Prior
analogous activities under NAICS 541611 have informed the requirements; this
...
SDVOSB set-aside scope, the Contractor shall comply with the
