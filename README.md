...
```
                  ...
                  └──┬───────────┬──┬────┘
                     │           │  │ traceparent
        ┌────────────▼──┐  ┌─────▼──▼─────────┐
        │ Solicitation   │  │ Evaluation       │   ← Spring Boot 2.7.18 (W4 target: 4.0.x + Java 21)
        │ Service        │  │ Service          │
        │ (Java) :8081   │  │ (Java) :8082     │
        └────┬───────┬───┘  └────┬─────┬───────┘
             │       │           │     │
...
| `services/api-gateway/` | Auth edge + routing | Spring Boot 2.7.18 + Spring Cloud Gateway + OAuth2 Resource Server (Java 11; W4 modernizes to SB 4.0.x + Java 21) | 8080 |
| `services/solicitation-service/` | FAR/DFARS solicitation CRUD | Spring Boot 2.7.18 + JPA (Postgres) + MongoDB (Java 11; W4 modernizes to SB 4.0.x + Java 21) | 8081 |
| `services/evaluation-service/` | Evaluation panel coordination | Spring Boot 2.7.18 (Java 11; W4 modernizes to SB 4.0.x + Java 21) | 8082 |
